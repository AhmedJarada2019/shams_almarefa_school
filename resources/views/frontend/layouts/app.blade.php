...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/bootstrap-grid.rtl.min.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/hamburgers-menu.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/overlayscrollbars.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/main.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    {{-- Unified Font: Cairo for all pages --}}
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;500;600;700;800;900;1000&display=swap"
        rel="stylesheet">
    <title>@yield('title', $siteName ?? 'مدرسة شمس المعرفة')</title>
    @stack('styles')
...
<body>
    ...
    ">
        @foreach ([['url' => $ytUrl, 'icon' => 'fa-youtube', 'bg' => '#FF0000', 'label' => 'YouTube'], ['url' => $fbUrl, 'icon' => 'fa-facebook-f', 'bg' => '#1877F2', 'label' => 'Facebook'], ['url' => $igUrl, 'icon' => 'fa-instagram', 'bg' => '#E1306C', 'label' => 'Instagram']] as $social)
            <a href="{{ $social['url'] }}" target="_blank" rel="noopener noreferrer" aria-label="{{ $social['label'] }}"
                class="fixed-social-btn"
                style="width:44px;height:44px;background:{{ $social['bg'] }};color:#fff;
    ...
    <script src="{{ asset('frontend/js/overlayscrollbars.js') }}"></script>
