...
@section('title', 'تبرع — ' . ($siteName ?? 'مدرسة شمس المعرفة'))
        ...
        <div class="donation-content">
            <div class="qr-container">
                <div class="qr-item fade-in-up">
                    <div class="qr-code">
                        <img src="{{ asset('frontend/imgs/binance-qr-placeholder.png') }}" alt="Binance QR Code" onerror="this.src='https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=TKHCtsRSqCnNsZyUMBT3hpYtEM1jbXNLBm'">
                    </div>
                ...
                <div class="qr-item fade-in-up" style="animation-delay: 0.2s;">
                    <div class="qr-code">
                        <img src="{{ asset('frontend/imgs/gofundme-qr-placeholder.png') }}" alt="GoFundMe QR Code" onerror="this.src='https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=https://www.gofundme.com/f/help-provide-a-safe-learning-space-in-gaza'">
                    </div>
