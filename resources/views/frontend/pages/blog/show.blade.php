        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 style="color: #fff; font-size: 42px; font-weight: 800; margin-bottom: 15px;">{{ $post->title }}</h1>
                    @if($post->category)
                        <a href="{{ route('blog.category', $post->category) }}" class="blog-category-badge">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="fade-in-left">
                    <div class="blog-post-image">
                        <img src="{{ media_url($post->featured_image, 'frontend/imgs/article.png') }}" class="img-fluid w-100" alt="{{ $post->title }}">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="author-card fade-in-right">
                    <img src="{{ media_url($author['image'] ?? null, 'frontend/imgs/trainer2.png') }}" class="author-avatar" alt="{{ $author['name'] }}">
                    <h4>{{ $author['name'] }}</h4>
