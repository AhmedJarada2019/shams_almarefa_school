...
<form method="post" action="<?php echo e(route('admin.blog-author.update')); ?>" enctype="multipart/form-data" class="card card-custom">
    ...
    <div class="card-body">
        ...
        <div class="form-group"><label>نبذة</label><textarea data-quill="true" name="author_bio" class="form-control" rows="4" dir="rtl"><?php echo e(old('author_bio', $author['bio'])); ?></textarea></div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pro Book\Downloads\school_fixed_updated_1\school_fixed\resources\views/admin/blog-author/edit.blade.php ENDPATH**/ ?>