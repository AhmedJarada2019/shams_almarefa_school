<?php $__env->startSection('page_title', $category->exists ? 'تعديل تصنيف' : 'تصنيف جديد'); ?>
<?php $__env->startSection('content'); ?>
<form method="post" action="<?php echo e($category->exists ? route('admin.course-categories.update', $category) : route('admin.course-categories.store')); ?>" class="card card-custom">
    ...
    <div class="card-body">
        ...
        <div class="form-group"><label>الوصف</label><textarea data-quill="true" name="description" class="form-control" dir="rtl"><?php echo e(old('description', $category->description)); ?></textarea></div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pro Book\Desktop\school_fixed\resources\views/admin/course-categories/form.blade.php ENDPATH**/ ?>