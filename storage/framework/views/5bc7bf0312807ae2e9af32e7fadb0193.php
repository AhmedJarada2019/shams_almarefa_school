    ...
    <div id="loading-screen">
        <div class="loading-content">
            ...
            <div class="qr-container">
                <div class="qr-item">
                    <div class="qr-code">
                        <img src="<?php echo e(asset('frontend/imgs/binance-qr-placeholder.png')); ?>" alt="Binance QR Code" onerror="this.src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=TKHCtsRSqCnNsZyUMBT3hpYtEM1jbXNLBm'">
                    </div>
                ...
                <div class="qr-item">
                    <div class="qr-code">
                        <img src="<?php echo e(asset('frontend/imgs/gofundme-qr-placeholder.png')); ?>" alt="GoFundMe QR Code" onerror="this.src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://www.gofundme.com/f/help-provide-a-safe-learning-space-in-gaza'">
                    </div>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="text">
                            ...
                            <?php if($hero->description): ?>
                                <p class="mb-2rem"><?php echo $hero->description; ?></p>
                            <?php endif; ?>
                            <?php if($hero->button_text): ?>
                                <div class="d-inline-flex align-items-center gap-3 flex-wrap mt-3">
                                    <a href="<?php echo e($hero->button_url ?: route('courses.index')); ?>"
                                        class="btn btn-lg mx-2"><?php echo e($hero->button_text); ?></a>
                                    <a href="<?php echo e(route('apps')); ?>" class="btn btn-lg btn-outline"
            ...
            <div class="row d-flex align-items-center">
                <div class="col-md-6 about-content fade-in-left">
                    <div style="background: #fff; padding: 40px; border-radius: 20px; box-shadow: 0 10px 40px rgba(111, 45, 189, 0.1);">
                        ...
                        <a href="<?php echo e(route('about')); ?>" class="btn btn-lg btn-outline" style="border-color: var(--primary); color: var(--primary); padding: 12px 35px; font-weight: 700; border-radius: 50px;">عرض المزيد</a>
                    </div>
                </div>
            ...
            <div class="container py-5">
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-lg-6 d-inline-flex justify-content-lg-end mt-4 mt-lg-0">
                        <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-lg btn-outline" style="border-color: var(--primary); color: var(--primary); padding: 12px 35px; font-weight: 700; border-radius: 50px;">
                            عرض الكل
                        </a>
                    </div>
                </div>
            ...
            <div class="container py-5">
                <div class="row mb-5">
                    ...
                    <div class="col-lg-6 text-lg-end d-flex justify-content-end" style="padding: 30px 30px">
                        <a href="<?php echo e(route('blog.index')); ?>" class="btn btn-lg btn-outline" style="border-color: var(--primary); color: var(--primary); padding: 12px 35px; font-weight: 700; border-radius: 50px;">جميع المقالات</a>
                    </div>
                </div>
                <div class="row">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pro Book\Downloads\school_fixed_updated_1\school_fixed\resources\views/frontend/pages/home.blade.php ENDPATH**/ ?>