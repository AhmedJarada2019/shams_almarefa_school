...
<body>
    ...
    <div class="login-left">
        <div class="brand-logo">
            <img src="<?php echo e(asset('frontend/imgs/ChatGPT Image Jun 5, 2026, 06_40_29 PM.png')); ?>" alt="شعار المدرسة">
    ...
    <div class="login-right">
        ...
        <form method="post" action="<?php echo e(route('admin.login.submit')); ?>" style="width:100%;">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <div class="input-icon-wrap">
                    ...
                    <input type="email" name="email" class="form-control" dir="ltr"
                           value="<?php echo e(old('email')); ?>" placeholder="example@domain.com" required autofocus>
                </div>
            </div>
        ...
        <p style="margin-top:32px;font-size:12px;color:#9ca3af;text-align:center;">
            © <?php echo e(date('Y')); ?> مدرسة شمس المعرفة — جميع الحقوق محفوظة
        </p>
    </div>

</body>
</html>
<?php /**PATH C:\Users\Pro Book\Downloads\school_fixed_updated_1\school_fixed\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>