<?php
    ...
    $facebookUrl = \App\Models\Setting::get('social', 'facebook', '#');
    $twitterUrl = \App\Models\Setting::get('social', 'twitter', '#');
    $instagramUrl = \App\Models\Setting::get('social', 'instagram', '#');
    $linkedinUrl = \App\Models\Setting::get('social', 'linkedin', '#');
    $youtubeUrl = \App\Models\Setting::get('social', 'youtube', '#');
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 mb-4 mb-md-0" dir="rtl">
                ...
                <div class="d-flex gap-2 mt-3 flex-wrap">
                    <?php $__currentLoopData = [['url' => $youtubeUrl, 'icon' => 'fa-youtube', 'label' => 'YouTube'], ['url' => $linkedinUrl, 'icon' => 'fa-linkedin-in', 'label' => 'LinkedIn'], ['url' => $instagramUrl, 'icon' => 'fa-instagram', 'label' => 'Instagram'], ['url' => $twitterUrl, 'icon' => 'fa-twitter', 'label' => 'Twitter'], ['url' => $facebookUrl, 'icon' => 'fa-facebook-f', 'label' => 'Facebook']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\Pro Book\Desktop\school_fixed\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>