        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 style="color: #fff; font-size: 48px; font-weight: 800; margin-bottom: 15px;"><?php echo e(isset($currentCategory) ? $currentCategory->name : 'المقالات'); ?></h1>
                    <?php if(!empty($authorName)): ?>
                        <p style="color: rgba(255, 255, 255, 0.9); font-size: 20px; font-weight: 500;">بقلم: <?php echo e($authorName); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<div class="container-fluid py-5" style="background: #f8f7ff;">
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-center mt-5"><?php echo e($posts->links()); ?></div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pro Book\Downloads\school_fixed_updated_1\school_fixed\resources\views/frontend/pages/blog/index.blade.php ENDPATH**/ ?>