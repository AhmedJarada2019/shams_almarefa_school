        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto d-flex align-items-center justify-content-end">
                ...
                <div class="login d-none d-sm-flex me-2">
                    <a href="<?php echo e(route('apps')); ?>" target="_blank" class="btn btn-outline">
                        تبرع الان
                    </a>
                </div>
...
<?php /**PATH C:\Users\Pro Book\Downloads\school_fixed_updated_1\school_fixed\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>